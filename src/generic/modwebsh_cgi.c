...
int modwebsh_createcmd(Tcl_Interp *interp) {
  ...
  Tcl_CreateObjCommand(interp, "web::finalizer",
		       Web_Finalizer,
                       NULL,NULL);

  Tcl_CreateObjCommand(interp, "web::finalize",
		       Web_Finalize,
                       NULL,NULL);

  Tcl_CreateObjCommand(interp, "web::maineval",
		       Web_MainEval, 
                       NULL,NULL);

  Tcl_CreateObjCommand(interp, "web::interpcfg",
		       Web_InterpCfg,
                       NULL,NULL);
